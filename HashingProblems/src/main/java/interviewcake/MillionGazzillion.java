 ...
 * I'm making a search engine called MillionGazillion™.
 ...
 database, and follows links to other web pages. I noticed that my crawler was wasting a lot of time
 visiting the same pages over and over, so I made hash set visited where I'm storing URLs I've already visited. Now the
 ...
 */
public class MillionGazzillion {
